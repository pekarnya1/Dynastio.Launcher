...
namespace DConsole
{
    public class Program
    {
        ...
        {
            var dataManager = new PrivateServerDataManager(@"Data Source=C:\Users\Zhaleh\Desktop\data8\data.sqlite");
            var chest = dataManager.OpenConnection().GetUserChest("google:115521114537023379537");
        }
    }
